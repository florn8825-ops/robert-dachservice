...
$asset = static fn(string $file): string => get_template_directory_uri() . '/assets/' . rawurlencode($file);
$hero_image = $asset('Professionelles Dachdecker-Foto.jpeg');
$materials = [
    ['title' => 'Tondachziegel', 'text' => 'Natürliche Optik und vielseitige Gestaltungsmöglichkeiten für klassische und moderne Dächer.', 'url' => '/leistungen/dacheindeckung-erneuern/tondachziegel', 'image' => $asset('tondachziegel.png')],
    ['title' => 'Betondachsteine', 'text' => 'Robuste und vielseitige Dachsteine mit unterschiedlichen Formen und Oberflächen.', 'url' => '/leistungen/dacheindeckung-erneuern/betondachsteine', 'image' => $asset('Betondachstein.jpg')],
    ['title' => 'Schiefer', 'text' => 'Hochwertige, charaktervolle Dacheindeckung mit traditioneller Optik und vielfältigen Gestaltungsmöglichkeiten.', 'url' => '/leistungen/dacheindeckung-erneuern/schiefer', 'image' => $asset('schiefer.jpg')],
    ['title' => 'Bitumenschindeln', 'text' => 'Leichte und flexible Lösung für geeignete Dachformen und Einsatzbereiche.', 'url' => '/leistungen/dacheindeckung-erneuern/bitumenschindeln', 'image' => $asset('bitumenschindeln.jpg')],
    ['title' => 'Metall / Blech', 'text' => 'Moderne, langlebige und leichte Lösung für unterschiedliche Gebäude und Dachkonzepte.', 'url' => '/leistungen/dacheindeckung-erneuern/metall-blech', 'image' => $asset('metall-blech-dach.jpg')],
];
$services = [
...
<main id="main-content" class="rd-main">
    <section class="rd-hero"><div class="rd-container rd-hero__grid"><div><div class="rd-badge"><span></span>Dachdeckermeisterbetrieb · Köln, Bonn und Umgebung</div><h1>Ihr Dach.<strong>Unsere Verantwortung.</strong></h1><p class="rd-lead">Fachgerechte Dacharbeiten in Köln, Bonn und Umgebung – von der schnellen Reparatur bis zur kompletten Erneuerung Ihrer Dacheindeckung.</p><div class="rd-actions"><a class="rd-button" href="<?php echo esc_url(home_url('/kontakt/')); ?>">Kostenlos Anfrage stellen</a><a class="rd-button rd-button--outline" href="<?php echo esc_url($phone_href); ?>">☎ Jetzt anrufen</a></div><div class="rd-hero-stats"><div><b>24/7</b><span>Dachnotdienst</span></div><div><b>Köln</b><span>&amp; Bonn</span></div><div><b>Meister</b><span>Fachbetrieb</span></div><div><b>Direkt</b><span>erreichbar</span></div></div></div><div class="rd-hero-image"><img src="<?php echo esc_url($hero_image); ?>" alt="Professionelles Dachdecker-Foto: Echtes Baustellenbild mit Gerüst und LKW" fetchpriority="high"><div class="rd-image-card"><b>Fachgerechte Dacharbeiten</b><span>Persönliche Beratung und individuelle Lösungen.</span></div></div></div></section>
    <section class="rd-trust"><div class="rd-container rd-trust__grid"><div><b>✓ Meisterbetrieb</b><span>Fachkompetenz vom Profi</span></div><div><b>◷ 24/7 Notdienst</b><span>Bei akuten Dachschäden</span></div><div><b>⌖ Regional</b><span>Köln, Bonn &amp; Umgebung</span></div><div><b>★ Persönlich</b><span>Direkter Ansprechpartner</span></div></div></section>
    <section class="rd-section"><div class="rd-container rd-intro"><div><p class="rd-eyebrow">Dacharbeiten mit System</p><h2>Nicht jede Dachreparatur braucht ein neues Dach.</h2></div><div><p class="rd-large">Ob eine einzelne Dachziegel beschädigt ist, Wasser eindringt oder die bestehende Dacheindeckung nach vielen Jahren erneuert werden soll: Nicht jeder Schaden und nicht jedes alte Dach benötigt die gleiche Lösung.</p><p>Wir betrachten den vorhandenen Zustand und besprechen mit Ihnen, welche Arbeiten tatsächlich erforderlich sind. So wird der Leistungsumfang gezielt auf Ihr Dach abgestimmt – von der kleinen Reparatur bis zur umfangreicheren Dachsanierung.</p><a class="rd-text-link" href="<?php echo esc_url(home_url('/kontakt/')); ?>">Persönliche Einschätzung anfragen →</a></div></div></section>
    <section class="rd-section rd-section--sand"><div class="rd-container"><p class="rd-eyebrow">Unsere Leistungen</p><h2>Alles rund ums Dach.<strong>Fachgerecht aus einer Hand.</strong></h2><p class="rd-large rd-max">Von der schnellen Reparatur bis zur neuen Dacheindeckung: Robert Dachservice bietet fachgerechte Dacharbeiten für private und gewerbliche Immobilien in Köln, Bonn und Umgebung.</p><div class="rd-service-grid"><?php foreach ($services as $i => $service) : ?><a class="rd-card" href="<?php echo esc_url(home_url($service['url'])); ?>"><small><?php echo esc_html(str_pad((string) ($i + 1), 2, '0', STR_PAD_LEFT)); ?></small><span class="rd-icon">◆</span><h3><?php echo esc_html($service['title']); ?></h3><p><?php echo esc_html($service['text']); ?></p><b>Leistung ansehen →</b></a><?php endforeach; ?></div></div></section>
    <section class="rd-section"><div class="rd-container rd-two-col"><div class="rd-feature-image"><img src="<?php echo esc_url($asset('Dacheindeckung.jpeg')); ?>" alt="Dacheindeckung" loading="lazy"></div><div><p class="rd-eyebrow">Schwerpunkt</p><h2>Dacheindeckung erneuern –<strong>nicht automatisch das komplette Dach.</strong></h2><p>Eine alte Dacheindeckung bedeutet nicht automatisch, dass das gesamte Dach neu aufgebaut werden muss.</p><p>In vielen Fällen steht zunächst die Erneuerung der äußeren Dachdeckung im Mittelpunkt. Welche zusätzlichen Arbeiten notwendig sind, hängt vom Zustand der darunterliegenden Bauteile ab.</p><p>Deshalb betrachten wir unter anderem Dachlattung, Unterdeckung, Dämmung, Anschlüsse und – soweit erforderlich – die Holzkonstruktion.</p><a class="rd-button" href="<?php echo esc_url(home_url('/leistungen/dacheindeckung-erneuern/')); ?>">Dacheindeckung erneuern</a></div></div></section>
