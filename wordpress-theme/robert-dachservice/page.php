...
$service_slugs = [
    ...
    'tondachziegel','betondachsteine','schiefer','bitumenschindeln','metall-blech',
    'bitumen','epdm','pvc',
    'aufsparrendaemmung','zwischensparrendaemmung','untersparrendaemmung','dampfbremse',
    'dachrinnen','fallrohre','dachanschluesse','blechverwahrungen','kehlen','ortgang-first'
];
