...
if (in_array($slug,$region_slugs,true) || in_array($slug,$service_slugs,true)) wp_enqueue_style('robert-dachservice-service-region',get_template_directory_uri().'/assets/service-region.css',[],wp_get_theme()->get('Version'));
